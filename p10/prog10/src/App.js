...
setError('');
setIsSubmitted(true);
axios.post('http://localhost:3000/register', { usn, name,
...
<option value="CS641-cloud computing">CS641-cloud
computing</option>
<option value="CS642-Ethical Hacking">CS642-Ethical
Hacking</option>
<option value="CS644-Unix Programming">CS644-Unix
Programming</option>
</select>
</div>
{error && <p className="text-danger">{error}</p>}
<button type="submit" className="btn btnprimary">Submit</button>
<button type="button" className="btn btn-secondary ms2" onClick={resetForm}>Cancel</button>
</form>
</div>
</div>
{isSubmitted && !error && (
